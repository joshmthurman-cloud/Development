...
import { autoPlaceHarbors, calculateFairnessMetrics, DEFAULT_GENERATION_OPTIONS, generateMap } from '@/core';
...
import { Dimensions, InteractionManager, Modal, Pressable, ScrollView, StyleSheet, View } from 'react-native';
...
const MAP_WIDTH_TABLET = 640;
const MAP_HEIGHT_TABLET = 520;
  ...
  return (
    <>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={[styles.scrollContent, isTablet && styles.scrollContentTablet]}>
        ...
        {activeTab === 'auto' && isTablet && (
          <View style={styles.autoTabletRow}>
            <View style={styles.autoTabletLeft}>
              <View style={styles.card}>
                <ThemedText type="defaultSemiBold" style={styles.cardTitle}>Board</ThemedText>
                <View style={styles.chipRow}>
                  <Pressable style={[styles.chip, playerRange === '3-4' && styles.chipSelected]} onPress={() => setPlayerRange('3-4')}>
            ...
            <View style={styles.autoTabletRight}>
              <View style={styles.card}>
                <ThemedText type="defaultSemiBold" style={styles.cardTitle}>Map</ThemedText>
                <Pressable
                  style={[styles.mapPreview, styles.mapPreviewTablet, (!boardMatchesSettings || mapLoading) && styles.mapPreviewDimmed]}
                  onPress={() => boardMatchesSettings && !mapLoading && setMapViewerOpen(true)}
                >
                  <MapRenderer
                    tiles={boardMatchesSettings ? board.tiles : []}
...
const styles = StyleSheet.create({
  ...
  scrollContentTablet: { maxWidth: 980, alignSelf: 'center', width: '100%' },
  topSection: {},
  topSectionTablet: {},
  tabs: { flexDirection: 'row', marginBottom: 20 },
  autoTabletRow: { flexDirection: 'row', gap: 24, flex: 1 },
  autoTabletLeft: { flex: 1 },
  autoTabletRight: { flex: 2, minHeight: 520 },
  mapPreviewTablet: { minHeight: 520 },

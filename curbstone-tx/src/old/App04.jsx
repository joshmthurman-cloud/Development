...
export default function App() {
  ...
  const requiredFor = useMemo(() => ({
    ...
    Capture: ["PaymentType", "TransType", "Amount", "AuthKey", settings.useRegisterIdSpelling, "RefId"],
    Return: ["TransType", "Amount", "AuthKey", settings.useRegisterIdSpelling, "RefId", "PaymentType", "InvNum", "Token", "Expiry"],
    Reversal: ["TransType", "Amount", "AuthKey", settings.useRegisterIdSpelling, "RefId", "PaymentType", "InvNum", "Token", "Expiry"],
  ...
  const allowedTags = useMemo(() => {
    ...
    switch (transType) {
      ...
      case "Capture":
        return new Set([
          "PaymentType", "TransType", "Amount", "AuthKey", keyReg, "RefId", "InvNum", "ClerkId",
          "CustRef", "DestZipCode", "TaxAmount", "LocalTaxFlag"
        ]);
      case "Return":
        return new Set([
      ...
      case "Reversal":
        return new Set([
          "TransType", "Amount", "AuthKey", keyReg, "RefId", "PaymentType", "InvNum", "Token", "Expiry", "ReversalType", "ClerkId"
        ]);
      default:
        return new Set();
    }
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <section className="bg-white rounded-2xl shadow p-4 space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            {/* Row 2 */}
            {shouldShowField("Amount") && <LabeledInput label="Amount" value={amount} onChange={setAmount} type="number" placeholder={isMissing('Amount') ? 'Required' : 'e.g., 1.00'} missing={isMissing('Amount')} />}
...
// ---- UI helpers ----
function LabeledInput({ label, value, onChange, type = "text", placeholder, required = false, missing = false }) {
  return (
    <label className="flex flex-col gap-1">

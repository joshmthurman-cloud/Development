...
# Project 4 — Android Application

Mission: Native Android app optimized for capture, offline queue, and secure sync.
...
Logging Focus:
- Log WorkManager retries
- Log upload attempts
- Log posting lifecycle
